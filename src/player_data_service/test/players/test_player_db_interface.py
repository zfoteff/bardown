...
class TestPlayerDatabaseInterface:
    ...
    def test_get_players_success(self):
        ...
        with patch('players.player_db_interface.PlayerDAO') as mock_player_dao:
            mock_player_dao.from_tuple.side_effect = [
                Mock(spec=PlayerDAO),
                Mock(spec=PlayerDAO)
            ]
    ...
    def test_player_exists_by_id_found(self):
        ...
        assert "SELECT playerid FROM players WHERE playerid='07c48b11-acbb-4725-8f21-21468c6c7d71'" == call_args
    ...
    @pytest.mark.parametrize("filters_data,expected_query", [
        # Test various filter combinations
        ({"player_id": "123"}, "SELECT * FROM players WHERE playerid='123'"),
        ({"first_name": "John", "last_name": "Doe"}, "SELECT * FROM players WHERE firstname='John' AND lastname='Doe'"),
        ({"order": "ASC", "order_by": "first_name"}, "SELECT * FROM players ORDER BY first_name ASC"),
    ...
    def test_integration_create_and_get_player(self):
        ...
        with patch.object(self.db_interface, 'player_exists') as mock_player_exists:
            ...
            self.mock_client.execute_query.side_effect = [
                ...
                (True, [("created-player-id", "John", "Doe", "Attack", 15, "Senior", "School", "img.jpg", "2024-01-01", "2024-01-01")])  # Get operation
            ]
